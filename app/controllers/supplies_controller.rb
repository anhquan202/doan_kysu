class SuppliesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @supply.update(supply_params)
        format.html { redirect_to @supply, notice: "Supply was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to supplies_path, notice: "Supply was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_supply
      @supply = Supply.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def supply_params
      params.expect(supply: [ :supply_name, :unit ])
    end
end
