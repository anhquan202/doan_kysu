...
class UtilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utility" do
    assert_difference("Utility.count") do
      post utilities_url, params: { utility: { fee: @utility.fee, type: @utility.type, unit: @utility.unit } }
    end
  ...
  test "should update utility" do
    patch utility_url(@utility), params: { utility: { fee: @utility.fee, type: @utility.type, unit: @utility.unit } }
