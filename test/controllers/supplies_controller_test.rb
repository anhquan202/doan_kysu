...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference("Supply.count") do
      post supplies_url, params: { supply: { supply_name: @supply.supply_name, unit: @supply.unit } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { supply_name: @supply.supply_name, unit: @supply.unit } }
